...
namespace SanriJP.API.Migrations
{
    ...
    [Migration("20210512193714_Init1")]
    partial class Init1
    {
            ...
            modelBuilder.Entity("SanriJP.API.Models.CarOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarNumber = false,
                            ClientId = 1,
                            CreatedAt = new DateTime(2021, 5, 12, 19, 37, 13, 108, DateTimeKind.Utc).AddTicks(6809),
                            FOB = 65000,
                            LotNumber = "00521",
                            Parking = (byte)1,
                            Price = 145000,
            ...
            modelBuilder.Entity("SanriJP.API.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Confirm = false,
                            Country = "Kyrgyzstan",
                            CreatedAt = new DateTime(2021, 5, 12, 19, 37, 13, 101, DateTimeKind.Utc).AddTicks(7845),
            ...
            modelBuilder.Entity("SanriJP.API.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 5, 12, 19, 37, 13, 92, DateTimeKind.Utc).AddTicks(6170),
                            FullName = "Adminio",
                            Login = "ADMIN",
                            Password = "Admin123!@#",
                            Role = "Admin"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 5, 12, 19, 37, 13, 96, DateTimeKind.Utc).AddTicks(779),
                            FullName = "Managereto",
                            Login = "MANAGER",
                            Password = "Manager123!@#",
                            Role = "Manager"
